...
if __name__ == "__main__":
    ...
    thing1 = LabelledEntry(label="Some entry (centered)", character_width=5)
    thing1.grid_into(box1, column=0, row=0, padx=10)
    thing2 = LabelledEntry(label="Some other entry (left)", character_width=5)
    ...
    some_fig = MPLFigure(figsize=(6, 4))
    ...
    try:
        ...
        video.zoom_level = 4
        video.grid_into(app.window, column=0, row=2, pady=5, padx=5, sticky="")
    except Exception as err:
    ...
    view3.grid_into(app.window, column=1, row=2, pady=5, padx=5, sticky="nsew")
    ...
    canvas = CanvasView()
    canvas.grid_into(app.window, column=2, row=2, pady=5, padx=5, sticky="nsew")
