...
class TestDialog(envtest.MyTkTestCase):
    ...
    def test_classmethod_showwarning(self):
        reply = Dialog.showwarning("Warning message not that long", auto_click=(Dialog.Replies.Ok, 500))
        self.assertEqual(reply, Dialog.Replies.Ok)

    def test_classmethod_showerror(self):
        reply = Dialog.showerror("Error message not that long", auto_click=(Dialog.Replies.Ok, 500))
        self.assertEqual(reply, Dialog.Replies.Ok)
